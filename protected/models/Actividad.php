...
class Actividad extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('ACT_CORREL, ACT_NOMBRE, SUB_CORREL', 'required'),
			array('ACT_CORREL, SUB_CORREL', 'numerical', 'integerOnly'=>true),
			array('ACT_NOMBRE', 'length', 'max'=>150),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ACT_CORREL, ACT_NOMBRE, SUB_CORREL', 'safe', 'on'=>'search'),
		);
	}
